...
function createWindow () {
  ...
  mainWindow = new BrowserWindow({width: 1200, height: 800, webSecurity: false})
  let contents = mainWindow.webContents;
  // and load the index.html of the app.
  mainWindow.loadURL(`file://${__dirname}/index.html`)

  // const webview = mainWindow.getElementById('foo');
  const ret = globalShortcut.register('MediaPlayPause', () => {
    contents.executeJavaScript("MediaPlayPause()");
  })
